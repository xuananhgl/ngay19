...
<div id="main">
        ...
        <div id ="header">
           ...
           <?= $this->Html->link(__('edit'), ['action' => 'edit', $header->id]) ?><i class="fa-solid fa-pen"></i>
<!-- ====================================================================================================================== -->
                ...
                <div class="top">
                     <div class="header_container" >
                            ...
                            <?= $this->Html->image($interface->image_header) ?>
                                ...
                                <div class="container_title" style="font-size: 70px; position: absolute;
                                                                    top: <?= $header['top']- 305?>px;
                                                                    left: <?= $header['left_title']- 1150?>px;">
                                ...
                                <div class="container_button">
                                    <a href="" style="color: <?= $interface['color_header'] ?>;"><?= $header['bnt']?></a>
                                </div>
