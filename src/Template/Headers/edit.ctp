           ...
           <div class="top">
                        <div class="header_container">
                                ...
                                <div class="container_title" >
                                     <div id="draggable" class="ui-widget-content" style="background:#FFF; width:610px;   height: 250px; position: relative; top: px" >
                                    <div class="input textarea">
                                        <label for="top">top</label>
                                        <textarea name="top" maxlength="100" id="top"class="sp1"></textarea>
                                    </div>
                                    <div class="input textarea">
                                        <label for="left_title">left</label>
                                        <textarea name="left_title" maxlength="100" id="left_title"class="sp3"></textarea>
                                    </div>
                                     <!-- left:<span class="sp3"></span>px -->
                                    <!-- top:<span class="sp1"></span>px -->
                                ...
                                <div class="container_about">
                                    ...
                                    <p> <?=  $this->Form->input('about', ['id' => 'aaa', 'rows'=>'3']);?></p>
                                  
                                </div>  left:<span class="sp4"></span>px
                                    top:<span class="sp5"></span>px
                                </div>
                                <div class="container_button">
                                    <p><?=  $this->Form->control('bnt', ['id'=>'bbb']);?></p>
                                </div>
...
<?= $this->Form->create($pre) ?>
        ...
        <div class="slide_box1"></div>
            <div class="slider_content">
                <div class="slider_titel"> <p><?= $this->Form->control('title_pres');?></p>
                    <div class="next_pre">
                    ...
                    <div class="slider_h1"><h1><?= $this->Form->control('logo');?></h1></div>
                    <div class="slider_about"><p><?= $this->Form->control('about_pres', ['rows'=>'3']);?></p></div>
                    <div class="slider_note">
                        <div class="note"><?= $this->Form->control('author');?><a><?= $this->Form->control('dress');?></a></div> 
                        <div class="cycle"><a>Lire l’article <i class="fa-solid fa-arrow-up-right-from-square"></i></a><?= $this->Form->control('link'); ?> </div> 
